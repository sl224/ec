-- Danger: This script irreversibly removes all objects in the 'e2ude_core' schema.
...
PRINT 'All tables in schema e2ude_core have been dropped. Confirm expected outcome and restore from backup if necessary.';
