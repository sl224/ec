...
class StagingPipeline:
    ...
    def run(self):
        ...
        logger.info(f"Workers: {self.unzip_workers} IO Threads -> {self.process_workers} CPU Processes")

        # Thread Pool for Network I/O
        io_pool = ThreadPoolExecutor(max_workers=self.unzip_workers, thread_name_prefix="IO_Stage")
